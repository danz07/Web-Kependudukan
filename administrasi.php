...
<header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <div class="logo">
            <h1 class="text-light">
                <a href="beranda">
                    <img src="<?= $base_url; ?>asset_user/img/kota-banjar.png" alt="logo">
                    <small>DESA BOJONGKANTONG</small>
                </a>
            </h1>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="text-center">
                    <img src="<?= $base_url; ?>asset_user/img/kota-banjar.png" alt="logo" width="5%">
                    <h4>Masukan Data Pengajuan Administrasi</h4>
                    <!-- pencarian -->
                </div>
            </div>
                ...
                <form action="cetak_administrasi" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <button type="submit" name="cetak_data_administrasi" class="btn btn-block btn-success float-right"><i class="fas fa-save"></i> Cetak</button>
                        </div>
                    </div>
                </form>
            </section>
