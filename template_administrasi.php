      ...
      <tbody>
        <tr>
          <td align="left" width="200">
            <img src="kota-banjar.jpeg" alt="logo" width="80px">  
          </td>
          <td valign="bottom" align="center" width="300">
              <span>
                <b>PEMERINTAH BOJONGKANTONG<br>
                    KECAMATAN LANGENSARi<br>
                </b>
              </span>
              <div style="font-size: larger;">
                <span>
                  <b>DESA BOJONGKANTONG</b><br>
                </span>
              </div>
              <span style="font-size:12px">
                Alamat : Jalan Bojongkantong <br>
                <i>Email : bojongkantong@gmail.com</i><br>
              </span>
          </td>
      ...
      <tbody>
        ...
        <tr>
          <td colspan="3" valign="top" align="justify">
              <span style="font-size:17px">
                <br>
                Yang bertanda tangan dibawah ini Kepala Desa Bojongkantong Kecamatan Langensari Kota Banjar, Dengan ini menyatakan bahwa:
              </span>
          </td>
        </tr>
        <tr>
                    ...
                    <table border="0" cellpadding="1">
                      <tbody>
                        <tr>
                          ...
                          <td width="100">
                            <span style="font-size:17px">Bojongkantong</span>
                          </td>
                        </tr>
                        <tr>
                          <td width="100">
                          ...
                          <td width="100">
                            <span style="font-size:17px">Langensari</span>
                          </td>
                        </tr>
                        <tr>
                          <td width="100">
                            <span style="font-size:17px">c. Kota</span>
                          </td>
                          <td width="8">
                            <span style="font-size:17px">:</span>
                          </td>
                          <td width="100">
                            <span style="font-size:17px">Banjar</span>
                          </td>
                        </tr>
                      </tbody>
                    </table>
          ...
          <td colspan="3" valign="top">
            <div align="justify">
              <span style="font-size:17px">
                ...
                Adalah benar yang bersangkutan tersebut diatas merupakan penduduk Desa Bojongkantong yang saat ini mempunyai:
              </span>
            </div>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td valign="top" align="center">
              <span style="font-size:17px">
                ...
                <br>
                <br>  
                Dikeluarkan Di : Bojongkantong<br>
                Pada Tanggal : 
                <?php
              ...
              <span>  
                KEPALA DESA BOJONGKANTONG <br>
              </span>
              <img src="qr-code.png" alt="logo" width="150px">
              <br>
              <span><u>RIDHO RAMADHAN</u>
          </td>
        </tr>
      </tbody>
    </table>
